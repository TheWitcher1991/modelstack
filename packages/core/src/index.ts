...
export interface EntityDefinition<
	...
	TSchemas extends EntitySchemas<z.ZodTypeAny, z.ZodTypeAny, z.ZodTypeAny, z.ZodTypeAny | undefined>,
> {
	key: TKey
	endpoint: TEndpoint
	schemas: TSchemas
...
export interface EntityQueryKeys<TKey extends string> {
	all: readonly [TKey]
	list: <TParams = undefined>(params?: TParams) => readonly [TKey, 'list', TParams | undefined]
	detail: <TId extends Id>(id: TId) => readonly [TKey, 'detail', TId]
	infinite: <TParams = undefined>(params?: TParams) => readonly [TKey, 'infinite', TParams | undefined]
}
...
export type EntityId<TEntity extends EntityDefinition<string, string, any>> =
	InferSchema<TEntity['schemas']['id']>
...
export function defineEntity<
	...
	const TSchemas extends EntitySchemas<z.ZodTypeAny, z.ZodTypeAny, z.ZodTypeAny, z.ZodTypeAny | undefined>,
>(config: {
	key: TKey
	endpoint: TEndpoint
	schemas: TSchemas
...
export function createQueryKeys<const TKey extends string>(key: TKey): EntityQueryKeys<TKey> {
	return {
		all: [key],
...
export function createEntityPaths<const TEndpoint extends string>(endpoint: TEndpoint): EntityPaths<TEndpoint> {
	return {
		list: endpoint,
