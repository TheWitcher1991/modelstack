...
import type { Dictionary, EntityDefinition, EntityId, EntityQuery, EntityRead, EntityWrite } from '@modelstack/core'
...
export type EntityRepository<TEntity extends EntityDefinition<string, string, any>> = CrudRepository<
	EntityRead<TEntity>,
	EntityWrite<TEntity>,
	EntityQuery<TEntity>,
	EntityId<TEntity>
...
export function createCrudRepository<TEntity extends EntityDefinition<string, string, any>>(
	entity: TEntity,
	http: HttpClient,
